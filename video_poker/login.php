    ...
    <div id="login_content">
        ...
        <form method="POST" action="login.php">
            ...
            <table class="login_table">
                ...
                <tr>
                    <th class="login_label">Username:</th>
                    <td><input type="text" name="<?php echo REGISTER_USERNAME_KEY; ?>" value="<?php echo $register_username; ?>"> </td>
                </tr>
                <tr>
                    <th class="login_label">Password:</th>
                    <td><input type="password" name="<?php echo REGISTER_PASSWORD_KEY; ?>" value="<?php echo $register_password; ?>"> </td>
                </tr>
                <tr>
                    <th class="login_label">Confirm Password:</th>
                    <td><input type="password" name="<?php echo REGISTER_CONFIRM_PASSWORD_KEY; ?>" value="<?php echo $register_confirm_password; ?>"> </td>
                </tr>
                <tr>
